...
class TblRentApply extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['wx_id', 'project_id', 'machine_id', 'status', 'add_time', 'rent_period','black_amount','colours_amount', 'contain_paper', 'contain_colours'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'machine_id' => '分配机器',
            'monthly_rent' => '月租',
            'contain_paper' => '包含黑白张数',
            'contain_colours' => '包含彩色张数',
            'black_white' => '黑白价格',
            'black_amount' => '黑白读数',
            'colours_amount' => '彩色读数',
            'colours' => '彩色价格',
