...
//        ['class' => 'yii\grid\SerialColumn'],
        ...
        [
            ...
            'value' => function($model) {
                if ($model->nickname) {
                    return $model->nickname . Html::a('更换', ['/wxuser/select', 'url' => '/admin-rent/list?machineid=' . $model->machine_id], ['class' => 'btn btn-info btn-sm']);
                }

                return '<span class="not-set">(未设置)</span>' . Html::a('设置', ['/wxuser/select', 'url' => '/admin-rent/list?machineid=' . $model->machine_id], ['class' => 'btn btn-warning btn-sm']);
            }
        ],
        'phone',
        'name',
