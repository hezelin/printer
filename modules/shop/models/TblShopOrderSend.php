 ...
 */
class TblShopOrderSend extends TblShopOrder
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = TblShopOrder::find()->where(['tbl_shop_order.wx_id'=>Cache::getWid(),'tbl_shop_order.enable'=>'Y','tbl_shop_order.order_status'=>5])->joinWith(
            ['user','address']
        );
